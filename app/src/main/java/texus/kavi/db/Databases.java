...
public class Databases extends SQLiteOpenHelper  {
	...
	public static final String DATABASE_NAME = "Kavi.db";
	...
	private void loadQuery() {
		...
		query_create_tables.add(GalleryData.CREATE_TABE_QUERY);
	...
	private void loadTableNames() {
		tables.add(GalleryData.TABLE_NAME);
